...
class Game:
    ...
    def run(self) -> None:
        while self.running:
            self.mouse_coords = pygame.Vector2((int((pygame.mouse.get_pos()[0] - self.camera_offset[0])/ self.zoom_factor), int((pygame.mouse.get_pos()[1] - self.camera_offset[1])/ self.zoom_factor)))
